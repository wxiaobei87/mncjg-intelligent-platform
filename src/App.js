    ...
    <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 24, minHeight: 600 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
          <MetricCard label="R² Score" value="0.987" unit="" color={COLORS.primary} subtitle="NGBoost Test Set" icon="📊" />
...
function ModelBenchmarkPanel() {
  const models = [
    { name: "NGBoost", r2: 0.987, rmse: 3.85, category: "Boosting", color: COLORS.primary },
    { name: "CatBoost", r2: 0.981, rmse: 4.02, category: "Boosting", color: "#8b5cf6" },
    { name: "AdaBoost", r2: 0.981, rmse: 4.05, category: "Boosting", color: "#a78bfa" },
    { name: "Random Forest", r2: 0.942, rmse: 4.21, category: "Bagging", color: COLORS.secondary },
    { name: "ExtraTrees", r2: 0.939, rmse: 4.29, category: "Bagging", color: "#38bdf8" },
    { name: "XGBoost", r2: 0.937, rmse: 4.35, category: "Boosting", color: "#818cf8" },
    { name: "DecisionTree", r2: 0.851, rmse: 12.83, category: "Single Tree", color: COLORS.warning },
    { name: "ElasticNet", r2: 0.393, rmse: 12.47, category: "Linear", color: COLORS.accent },
    { name: "KNN", r2: 0.292, rmse: 13.52, category: "Instance", color: "#f97316" },
  ];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <div style={{ background: COLORS.card, border: `1px solid ${COLORS.border}`, borderRadius: 16, padding: 20 }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: COLORS.text, marginBottom: 16, fontFamily: "'Space Grotesk', sans-serif" }}>
            🎯 NGBoost: Predicted vs. Actual (R² = 0.987)
          </div>
          <ResponsiveContainer width="100%" height={320}>
            <ScatterChart>
              <CartesianGrid strokeDasharray="3 3" stroke={COLORS.border} />
...
function ValidationPanel() {
  const validationData = [
    ...
    { scenario: "VS3", target: "As(III)", condition: "pH=5.0, C₀=8.0 mg/L, t=30 min (NCJG)", predicted: 78.3, experimental: 75.9, expStd: 1.3 },
  ];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
        ...
        <MetricCard label="Validation Pts" value="4" unit="" color={COLORS.warning} subtitle="Independent Experiments" icon="🧪" />
        <MetricCard label="Max Error" value="2.4" unit="%" color={COLORS.accent} subtitle="VS3 As(III)" icon="📏" />
      </div>
